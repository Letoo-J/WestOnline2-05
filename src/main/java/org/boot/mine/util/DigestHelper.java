...
public class DigestHelper {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		System.out.println( digest("233333", "MD5") );
		System.out.println( digest("233333", "SHA") );
		System.out.println( digest("233333", "SHA1") );
		System.out.println( digest("233333", "SHA-256") );
		System.out.println( digest("233333", "SHA-384") );
		System.out.println( digest("233333", "SHA-512") );
	}
}
