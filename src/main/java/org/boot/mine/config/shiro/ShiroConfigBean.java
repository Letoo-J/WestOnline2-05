...
import org.boot.mine.config.shiro.MyShiroRealm;
import org.boot.mine.filter.AddPrincipalToSessionFilter;
import org.boot.mine.filter.KickoutSessionControlFilter;
import org.boot.mine.filter.ShiroLogoutFilter;
import org.boot.mine.filter.ShiroSessionListener;
...
public class ShiroConfigBean {
	...
	public ShiroFilterFactoryBean shiroFilter(DefaultWebSecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/hhh.png", "anon");
...
//	}
    ...
    public RedisManager redisManager() {
        ...
        redisManager.setPort(6379);  //redis_port
    ...
    public KickoutSessionControlFilter kickoutSessionControlFilter() {
        ...
        //被踢出后重定向到的地址；
        kickoutSessionControlFilter.setKickoutUrl("/login");  //kickoutUrl
...
//		System.out.println("shiro配置：ShiroConfiguration.getEhCacheManager()");
